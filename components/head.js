...
const HeadComponent = () => (
  <Head>
    ...
    <meta name="description" content={brand.crypto.desc} />
    {/* Favicon */}
    <link rel="shortcut icon" href="/favicons/smart-favicon.ico" />
    ...
    <meta property="twitter:image:src" content="/images/logo-crypto.png" />
    <meta property="og:url" content={brand.crypto.url} />
    <meta property="og:title" content={brand.crypto.name} />
    <meta property="og:description" content={brand.crypto.desc} />
