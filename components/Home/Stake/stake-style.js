...
const benefitStyles = makeStyles((theme) => ({
  root: {
    ...
    background:
      theme.palette.type === "dark"
        ? `linear-gradient(120deg, ${darken(
            theme.palette.primary.main,
            0.6
          )}, ${darken(theme.palette.secondary.main, 0.6)})`
        : `linear-gradient(120deg, ${lighten(
            theme.palette.primary.main,
            0.9
    ...
    '& ul[class*="slick-dots"]': {
      ...
      "& li": {
        ...
        '&[class="slick-active"]': {
          ...
          background:
            theme.palette.type === "dark"
              ? `linear-gradient(120deg, ${theme.palette.secondary.light}, ${theme.palette.primary.light})`
              : `linear-gradient(120deg, ${theme.palette.secondary.main}, ${theme.palette.primary.main})`,
        },
        "& button:before": {
          display: "none",
        },
  ...
  border: {
    boxShadow:
      theme.palette.type === "dark" ? theme.shade.dark : theme.shade.light,
